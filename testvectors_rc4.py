# -*- coding: utf-8 -*-
"""
Created on Tue Nov 18 16:24:51 2014
...
The testvectors were published by the ietf and can be seen here: http://tools.ietf.org/html/rfc6229
"""
from rc4 import RC4

testkeys = [
[0x01, 0x02, 0x03, 0x04, 0x05], # 40bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07], #56bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08], #64bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A], #80bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10], #128bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18], #192bit
[0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20], #256bit
...
for i in range(len(testkeys)):
    ...
    testRC4 = RC4(testkey, 2**8)
    testOutput = [testRC4.getNextKeybyte() for i in range(0x1000 + 16)]

    print("Testing results for Key: %s" % testkey)
    print(testOutput[0:32]         == testVector[0])
    print(testOutput[240:240+32]   == testVector[1])
    print(testOutput[496:496+32]   == testVector[2])
    print(testOutput[752:752+32]   == testVector[3])
    print(testOutput[1008:1008+32] == testVector[4])
    print(testOutput[1520:1520+32] == testVector[5])
    print(testOutput[2032:2032+32] == testVector[6])
    print(testOutput[3056:3056+32] == testVector[7])
    print(testOutput[4080:4080+32] == testVector[8])
    print("\n")